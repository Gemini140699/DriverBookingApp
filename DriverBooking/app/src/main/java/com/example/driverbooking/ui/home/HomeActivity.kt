...
import com.example.driverbooking.databinding.ActivityHomeBinding
import com.example.driverbooking.login.LoginActivity
...
class HomeActivity : AppCompatActivity() {
    ...
    private lateinit var driverAvatar: ImageView
    ...
    private fun setupDriverInfo() {
        ...
        val driverStar = headerView.findViewById<TextView>(R.id.driver_star)
        val driverName = headerView.findViewById<TextView>(R.id.driver_name)
        val driverPhone = headerView.findViewById<TextView>(R.id.driver_phone)
        val driverEmail = headerView.findViewById<TextView>(R.id.driver_email)
        driverAvatar = headerView.findViewById(R.id.img_avatar)
        val user = FirebaseAuth.getInstance().currentUser
        val listInfo = ArrayList<String>()
        driverInfoReference =
            FirebaseDatabase.getInstance().getReference("driverInfo").child(user!!.uid)
        driverInfoReference.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                Glide.with(this@HomeActivity)
                    ...
                    .into(driverAvatar)
                driverStar.text = dataSnapshot.child("rating").value.toString()
                driverName.text =
